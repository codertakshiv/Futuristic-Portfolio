    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        <motion.img
          ...
          animate={isClient ? { scale: isHovered ? 1.1 : 1, opacity: isHovered ? 1 : 0.9 } : { scale: 1, opacity: 0.9 }}
        ...
        <motion.div
          ...
          animate={isClient ? { opacity: isHovered ? 1 : 0.7 } : { opacity: 0.7 }}
        ...
        <motion.div
          ...
          animate={isClient ? { opacity: isHovered ? 1 : 0 } : { opacity: 0 }}
          transition={{ duration: 0.5 }}
        />
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="space-y-2">
          <motion.h3
            animate={isClient ? { color: isHovered ? '#00ffff' : '#ffffff' } : { color: '#ffffff' }}
          ...
          <motion.p
            animate={isClient ? { color: isHovered ? 'rgba(255, 255, 255, 0.9)' : 'rgba(255, 255, 255, 0.6)', y: isHovered ? -2 : 0 } : { color: 'rgba(255, 255, 255, 0.6)', y: 0 }}
            transition={{ duration: 0.5 }}
        ...
        <div className="flex items-center justify-between pt-2">
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            animate={isClient ? { y: isHovered ? 0 : 4, opacity: isHovered ? 1 : 0.9 } : { y: 4, opacity: 0.9 }}
            transition={{ duration: 0.3 }}
          ...
          >
            {project.demoLabel}
            <motion.svg
              animate={isClient ? { x: isHovered ? 4 : 0 } : { x: 0 }}
              transition={{ duration: 0.3 }}
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"
      ...
      <motion.div
        ...
        animate={isClient ? { opacity: isHovered ? 0.2 : 0 } : { opacity: 0 }}
        transition={{ duration: 0.5 }}
